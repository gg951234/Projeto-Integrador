...
var stats = {
	"Default": {
		...
		"hitbox": {
				"Down":  { "pos": Vector2(0,  -8), "size": Vector2(128, 100) },
				"Up":    { "pos": Vector2(0, -50), "size": Vector2(128, 100) },
				"Right": { "pos": Vector2(10, -10), "size": Vector2(140, 68) },
				"Left":  { "pos": Vector2(-10, -10), "size": Vector2(140, 68) },
		}
	},
	"Frost": {
		"health": 200,
